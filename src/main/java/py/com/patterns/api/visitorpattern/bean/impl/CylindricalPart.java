...
public class CylindricalPart extends Part {
	...
	public CylindricalPart(Integer id, String description, BigDecimal height, BigDecimal width, BigDecimal depth,
	...
	public String format() {
		...
		for(Visitor<?> visitor: this.visitors) {
			if(visitor instanceof CylindricalPartVisitor) {				
				return ((CylindricalPartVisitor)visitor).visit(this);
			}
		}
		return null;
	}
